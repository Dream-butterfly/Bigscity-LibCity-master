...
from libcity_new.config import ConfigParser
from libcity_new.data import get_dataset
from libcity_new.utils import get_executor, get_logger, get_model, set_random_seed, str2bool
...
def main():
    ...
    parser.add_argument("--dataset", type=str, default="PEMSD4", help="the name of dataset")
