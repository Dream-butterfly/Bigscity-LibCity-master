"""
FastAPI web demo for GNNTP model training and result visualization.
"""
...
MODELS_ROOT = PROJECT_ROOT / "GNNTP" / "models"
    ...
    t = threading.Thread(
        ...
        args=(
            ...
            ["--run_id", exp_id, "--artifact_id", artifact_meta["artifact_id"],
             "--epoch", str(epoch), "--max_epoch", str(max_epoch)],
            False,
            False,
            exp_id,
        ),
...
def main() -> None:
    parser = argparse.ArgumentParser(description="FastAPI web demo for GNNTP training")
