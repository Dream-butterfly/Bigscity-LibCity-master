...
class GraphWaveNet(AbstractTrafficStateModel):
    """
    Paper: Graph WaveNet for Deep Spatial-Temporal Graph Modeling (IJCAI 2019)

    Migrated from Bigscity-LibCity-master/libcity/model/traffic_speed_prediction/GWNET.py
    """
