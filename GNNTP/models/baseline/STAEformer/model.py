...
class AttentionLayer(nn.Module):
    ...
    Supports different src and tgt length. Must `src length == K length == V length`.
    """
...
class STAEformer(AbstractTrafficStateModel):
    """
    Paper: STAEformer: Spatio-Temporal Adaptive Embedding Makes
           Vanilla Transformer SOTA for Traffic Forecasting (CIKM 2023)

    Migrated from Bigscity-LibCity-master/libcity/model/traffic_speed_prediction/STAEformer.py
    """
