...
class STID(AbstractTrafficStateModel):
    """
    Paper: Spatial-Temporal Identity: A Simple yet Effective Baseline
           for Multivariate Time Series Forecasting
    Link: https://arxiv.org/abs/2208.05233
    Official Code: https://github.com/zezhishao/STID

    Migrated from Bigscity-LibCity-master/libcity/model/traffic_speed_prediction/STID.py
    """
    ...
    def __init__(self, config, data_feature):
        ...
        self.time_series_emb_layer = nn.Conv2d(
            in_channels=self.output_dim * self.input_window, out_channels=self.time_series_emb_dim,
