...
from GNNTP.data.core.batch import Batch, BatchPAD
...
def generate_dataloader(train_data, eval_data, test_data, feature_name,
    ...
    Args:
        ...
        train_sampler(torch.utils.data.Sampler | None): DDP 训练 sampler
        eval_sampler(torch.utils.data.Sampler | None): DDP 验证 sampler
        test_sampler(torch.utils.data.Sampler | None): DDP 测试 sampler
